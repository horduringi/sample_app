...
describe "cytostatic_drug_given_bone_marrows/edit" do
  before(:each) do
  ...
  it "renders the edit cytostatic_drug_given_bone_marrow form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => cytostatic_drug_given_bone_marrows_path(@cytostatic_drug_given_bone_marrow), :method => "post" do
